...
This update modifies the stored data structure to align with the new v2 data model.
Once you have migrated and are running v2, you will not be able to roll back to v1
without restoring from a backup.

**Before proceeding**, take a full backup of your MinIO data directory
(e.g. `./minio_data/`) and keep it until you have confirmed the upgrade is stable.
:::
