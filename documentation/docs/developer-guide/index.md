...
| Placeholder | Meaning |
|---|---|
| `https://your-resolver.example.com/api/1.0.0` | Your resolver's base URL (global prefix included) |
...
```bash
curl -X POST https://your-resolver.example.com/api/1.0.0/identifiers \
...
```bash
curl https://your-resolver.example.com/api/1.0.0/identifiers?namespace=acme \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X DELETE https://your-resolver.example.com/api/1.0.0/identifiers?namespace=acme \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST https://your-resolver.example.com/api/1.0.0/resolver \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "namespace": "acme",
...
```
GET /api/1.0.0/acme/01/12345?linkType=acme:certificationInfo&decryptionKey=a3f2b8c1
```
...
```bash
curl "https://your-resolver.example.com/api/1.0.0/resolver/links?namespace=acme&identificationKeyType=product&identificationKey=12345" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl https://your-resolver.example.com/api/1.0.0/resolver/links/a1b2c3d4-e5f6-7890-abcd-ef1234567890 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X PUT https://your-resolver.example.com/api/1.0.0/resolver/links/a1b2c3d4-e5f6-7890-abcd-ef1234567890 \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://your-resolver.example.com/api/1.0.0/resolver/links/a1b2c3d4-e5f6-7890-abcd-ef1234567890 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X DELETE "https://your-resolver.example.com/api/1.0.0/resolver/links/a1b2c3d4-e5f6-7890-abcd-ef1234567890?hard=true" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -v https://your-resolver.example.com/api/1.0.0/acme/01/12345/10/A1B2C3?linkType=acme:sustainabilityInfo
```
...
```bash
curl https://your-resolver.example.com/api/1.0.0/acme/01/12345?linkType=all
```
...
```json
{
  "linkset": [
    {
      "anchor": "https://your-resolver.example.com/api/1.0.0/acme/01/12345",
      "https://your-resolver.example.com/api/1.0.0/voc/sustainabilityInfo": [
        {
      ...
      "https://your-resolver.example.com/api/1.0.0/voc/productDatasheet": [
        {
...
(e.g., `https://your-resolver.example.com/api/1.0.0/voc/sustainabilityInfo`),
...
```bash
curl https://your-resolver.example.com/api/1.0.0/.well-known/resolver
```
...
```json
{
  ...
  "resolverRoot": "https://your-resolver.example.com/api/1.0.0",
  "supportedLinkType": [
    {
