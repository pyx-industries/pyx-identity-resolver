...
|-------|-------------|----------|
| Standard | `1.1.3` | Docker, Docker Compose, Kubernetes |
| Serverless | `1.1.3-serverless` | AWS Lambda container deployments |
...
:::tip
Pin to a specific version tag (e.g. `1.1.3`) in production
...
docker run -d \
  -p 3000:3000 \
  --env-file .env \
  ghcr.io/pyx-industries/pyx-identity-resolver:1.1.3
```
