...
| `RESOLVER_DOMAIN` | **Yes** | --- | The public base URL of your resolver, including the API version path. Example: `https://resolver.example.com/api/1.0.0` |
...
```
https://resolver.example.com/api/1.0.0
```
...
|----------|-----------------|
| `RESOLVER_DOMAIN` | `https://resolver.example.com/api/1.0.0` (use your actual host) |
| `APP_NAME` | `IDR` |
